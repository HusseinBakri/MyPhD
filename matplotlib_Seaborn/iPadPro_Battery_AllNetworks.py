...
df = pd.read_excel('datasets/iPadBatteryAllNetworks.xlsx', sheetname='Sheet1', header=None)
print(df)
...
plt.savefig('datasets/plots/iPadProBatteryAllNetworks.png')
# plt.savefig('datasets/plots/iPadProBatteryAllNetworks.pdf')
plt.savefig('datasets/plots/iPadProBatteryAllNetworks_HighDPI.png', dpi=200)
# plt.savefig('datasets/plots/iPadProBatteryAllNetworks_HighDPI.pdf', dpi=600)
