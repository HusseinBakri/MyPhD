...
df = pd.read_excel('datasets/iPadBoneCupAllNetworks.xlsx', sheetname='Sheet1', header=None)
print(df)
...
Annotations_WithHannibal = ['360 Sprite', '360 Sprite', '200K', '300K', '300K']
...
plt.savefig('datasets/plots/iPadProBoneCupAllNetworks.png')
# plt.savefig('datasets/plots/iPadProBoneCupAllNetworks.pdf')
plt.savefig('datasets/plots/iPadProBoneCupAllNetworks_HighDPI.png', dpi=200)
# plt.savefig('datasets/plots/iPadProBoneCupAllNetworks_HighDPI.pdf', dpi=600)
