...
df = pd.read_excel('datasets/PCBatteryAllNetworks.xlsx', sheetname='Sheet1', header=None)
print(df)
...
Annotations_WithNoHannibal = ['', '', '2.7M', '2.7M', '2.7M', '2.7M']
...
plt.savefig('datasets/plots/PCBatteryAllNetworks.png')
plt.savefig('datasets/plots/PCBatteryAllNetworks_HighDPI.png', dpi=200)
