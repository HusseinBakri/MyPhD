...
df = pd.read_excel('datasets/Nexus4BoneCupAllNetworks.xlsx', sheetname='Sheet1', header=None)
print(df)
...
plt.savefig('datasets/plots/Nexus4BoneCupAllNetworks.png')
plt.savefig('datasets/plots/Nexus4BoneCupAllNetworks_HighDPI.png', dpi=200)
